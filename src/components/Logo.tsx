...
export const Logo: React.FC<LogoProps> = ({
  ...
  const sizeClasses = {
    ...
    hero: 'h-16 sm:h-20 md:h-24 w-auto max-w-[120px] sm:max-w-[150px] md:max-w-[180px] drop-shadow-[0_6px_18px_rgba(212,175,55,0.3)]',
  ...
  const fallbackPng = src || '/images/logo.png';
